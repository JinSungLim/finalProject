...
public class SnsMapper {
	...
	/*
	 * public int getLikeSu(int sns_board_num) { return
	 * sqlSession.selectOne("getLikeSu",sns_board_num); }
	 * 
	 * 
	 * 
	 * public int likeSns(int sns_board_num, int member_num) {
	 * 
	 * java.util.Map<String, Integer> map = new HashMap<String, Integer>();
	 * map.put("sns_board_num",sns_board_num); map.put("member_num",member_num); int
	 * res = sqlSession.update("likeSns",sns_board_num); int res2 =
	 * sqlSession.delete("addLike", map);
	 * 
	 * 
	 * if (res > 0 && res2 > 0) { return 1; } else { return -1; }
	 * 
	 * 
	 * }
	 * 
	 * 
	 * 
	 * public int removeLikeSns(int sns_board_num, int member_num) {
	 * 
	 * java.util.Map<String, Integer> map = new HashMap<String, Integer>();
	 * map.put("sns_board_num",sns_board_num); map.put("member_num",member_num); int
	 * res = sqlSession.update("removeLikeSns",sns_board_num); int res2 =
	 * sqlSession.delete("removeLike", map);
	 * 
	 * 
	 * if (res > 0 && res2 > 0) { return 1; } else { return -1; }
	 * 
