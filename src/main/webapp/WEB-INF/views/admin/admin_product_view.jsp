...
<form name="f" action="admin_product_view.do" method="post" enctype="multipart/form-data">
	<div class="container">
		<div class="row">
				...
				<tbody>
                  ...
                  <td class="table-light">수량</td>
					...
					<tr>
						...
						<td>
							<div class="d-flex align-items-center">
								<input type="text" class="form-control" style="width: 300px;" id="add_price" name="product_margin" readonly="readonly" value="	${getProd.product_margin}"> KRW
							</div>
						</td>
					</tr>
