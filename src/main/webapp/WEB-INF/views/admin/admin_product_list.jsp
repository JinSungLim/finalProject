					...
					<tr>
						...
						<c:if test="${not empty listProd}">
							<c:forEach var="dto" items="${listProd}">
								<th width="10%" ><input type="checkbox" name="RowCheck" value="${dto.product_num}"> <!-- 	 <label class="form-check-label" for="flexCheckDefault">
		                </label>       --></th>
								...
								<td width="20%" align="center"><a href="admin_product_view.do?product_num=${dto.product_num}"> <img src="resources/product_images/${dto.product_image1}" class="card-img" alt="..." width="5px" height="50px">
								</a></td>
